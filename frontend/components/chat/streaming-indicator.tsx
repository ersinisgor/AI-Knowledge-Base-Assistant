    ...
    <div className="flex gap-3 mb-6">
      ...
      <div className="flex-1">
        ...
        <div className="mt-2">
          <button
            onClick={onStop}
            className="bg-red-500/15 border border-red-500/30 text-red-400 px-2.5 py-1 rounded text-base inline-flex items-center gap-1 hover:bg-red-500/25 transition-colors"
          >
